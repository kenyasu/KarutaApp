...
class TournamentsTest < ApplicationSystemTestCase
  ...
  test "creating a Tournament" do
    ...
    fill_in "Access", with: @tournament.access
    fill_in "Applicationperiod", with: @tournament.applicationPeriod
    fill_in "Capacity", with: @tournament.capacity
    fill_in "Class", with: @tournament.class
    fill_in "Date", with: @tournament.date
    fill_in "Entryfee", with: @tournament.entryFee
    fill_in "Host", with: @tournament.host
