...
class JokersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joker" do
    assert_difference('Joker.count') do
      post jokers_url, params: { joker: { karuta_id: @joker.karuta_id, result_id: @joker.result_id } }
    end
  ...
  test "should update joker" do
    patch joker_url(@joker), params: { joker: { karuta_id: @joker.karuta_id, result_id: @joker.result_id } }
